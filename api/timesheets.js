...
// Checks if the timesheetId provided exists, returns 404 if not
const timesheetIdCheck = (req, res, next) => {
...
timesheetsRouter.put('/:timesheetId', timesheetIdCheck, (req, res, next) => {
  const hours = req.body.timesheet.hours,
        rate = req.body.timesheet.rate,
        date = req.body.timesheet.date,
        employeeId = req.params.employeeId,
...
timesheetsRouter.delete('/:timesheetId', timesheetIdCheck, (req, res, next) => {
